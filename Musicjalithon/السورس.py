...
async def restart(client, m: Message):
    ...
    await jmthon.edit("8")
    await jmthon.edit("9")
    await jmthon.edit("**تم اعادة تشغيل سورس انثون ميوزك بنجاح ✓**")
...
- أوامر المستخدمين: 
• {HNDLR}`تشغبل` [عنوان المطقع | رابط يوتيوب | الرد على ملف مقطع صوتي] - لتشغيل مقطع صوتي في المكالمه
...
• {HNDLR}الاوامر - لعرض اوامر سورس ميوزك انثون
